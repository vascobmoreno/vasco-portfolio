...
// ─────────────────────────────────────────────────────────────────
// To receive emails: go to https://web3forms.com, enter
// vascobmoreno@gmail.com, and replace the string below with the
// access key they send to your inbox. No account needed.
// ─────────────────────────────────────────────────────────────────
const ACCESS_KEY = "6fcd4577-1d84-430a-93f2-5d361115a8ee";
  ...
  return (
    ...
    >
      <div className="max-w-xl mx-auto">
        ...
        <p className="font-mono text-[10px] tracking-[0.5em] text-[#00ffcc]/35 uppercase mb-3">
          Get in touch
        </p>
        ...
        <p className="text-gray-400 text-sm font-mono mb-12 leading-relaxed">
          Open to freelance projects, consulting, services maintenance, and
        ...
        <AnimatePresence mode="wait">
          {status === "sent" ? (
            ...
            >
              ...
              <div>
                <p className="font-mono text-[#00ffcc] tracking-[0.3em] uppercase text-sm mb-1">
                  Message sent
                </p>
            ...
            >
              ...
              {status === "error" && (
                <p className="font-mono text-xs text-red-400/80">
                  ...
                  <a
                    ...
                    className="text-[#00ffcc]/60 hover:text-[#00ffcc] underline underline-offset-2"
                  >
                    vascobmoreno@gmail.com
                  </a>
                </p>
              )}
              ...
              >
                {status === "sending" ? (
                  <>
                    <span className="w-3 h-3 border border-[#00ffcc]/40 border-t-[#00ffcc] rounded-full animate-spin" />
                    Sending...
                  </>
                ) : (
                  "Send Message →"
